...
const cars = [
  {
    ...
    bg: "#100500",
    accent: "#ff7a2b",
    img: "https://pngimg.com/uploads/Mclaren/Mclaren_PNG74.png",
  },
  {
    model: "720S",
    series: "Super Series",
    name1: "720", name2: "S", name3: "Super Series",
    desc: "The 720S is a force of nature. Inspired by nature's most perfect aerodynamic form, it delivers 720PS and 0–100 in just 2.9 seconds. Carbon fibre MonoCage II.",
    stats: ["2.9s", "212", "720"],
    price: "$299,000",
    color: "#00cfff",
    ...
    bg: "#000c12",
    accent: "#5de0ff",
    img: "https://pngimg.com/uploads/Mclaren/Mclaren_PNG28.png",
  },
  {
    model: "Artura",
    series: "High Performance Hybrid",
    name1: "ART", name2: "URA", name3: "HPH",
    desc: "McLaren's first series-production High-Performance Hybrid. The V6 and electric motor combine for 700PS, with advanced MCLA carbon architecture shaping every curve.",
    stats: ["3.0s", "205", "700"],
    price: "$237,000",
    color: "#c77dff",
    ...
    bg: "#0a0012",
    accent: "#e0aaff",
    img: "https://pngimg.com/uploads/Mclaren/Mclaren_PNG22.png",
  },
  {
    model: "750S",
    series: "Super Series",
    name1: "750", name2: "S", name3: "Super Series",
    desc: "The lightest and most powerful McLaren series-production supercar ever. 750PS. 800Nm. Relentless progress, distilled. A new benchmark for engagement and purity.",
    stats: ["2.8s", "206", "750"],
    price: "$319,000",
    color: "#ff2040",
    ...
    bg: "#0f0003",
    accent: "#ff5570",
    img: "https://pngimg.com/uploads/Mclaren/Mclaren_PNG24.png",
  },
];
